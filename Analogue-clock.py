...
hHand.color("white")
hHand.speed(10)
hHand.shapesize(stretch_wid=1.4, stretch_len=18)

mHand = Turtle()
mHand.shape("arrow")
mHand.color("white")
mHand.speed(10)
mHand.shapesize(stretch_wid=1.4, stretch_len=26)
...
centerCircle.shapesize(stretch_wid=2.5, stretch_len=2.5)
...
def movesHand():
    ...
    a.ontimer(movesHand, 1000)


a.ontimer(movehHand, 1)
a.ontimer(movemHand, 1)
a.ontimer(movesHand, 1)
a.exitonclick()